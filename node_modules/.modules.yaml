...
hoistedDependencies:
  ...
  /@jest/core/28.1.2_ts-node@10.8.1:
    '@jest/core': private
  ...
  /jest-circus/28.1.2:
    jest-circus: private
  /jest-cli/28.1.2_jbmz3vlfopghb5mdasddsdxfzq:
    jest-cli: private
  /jest-config/28.1.2_jbmz3vlfopghb5mdasddsdxfzq:
    jest-config: private
  /jest-diff/28.1.1:
    jest-diff: private
...
pendingBuilds: []
prunedAt: Sat, 02 Jul 2022 07:48:51 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
skipped: []
storeDir: /Users/spicyzboss/Library/pnpm/store/v3
